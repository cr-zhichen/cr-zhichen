...
* **Unity** — C# game development and engine systems
...
* 🔹 **Unity Developer**
  ...
  * Architected and developed interactive 2D/3D games and simulations
  * Optimized performance, implemented gameplay mechanics, and collaborated on UI/UX

* 🔹 **Backend Developer (.NET)**

  * Designed and deployed RESTful APIs with .NET Core and SQL databases
  * Managed production deployments and integrated with CI/CD workflows
